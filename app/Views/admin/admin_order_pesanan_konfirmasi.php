        ...
        <section class="w-full h-auto py-8 px-12 rounded-lg bg-slate-400">
            ...
            <div class="mt-1 bg-slate-100 py-6 px-8 font-semibold">
                ...
                <div class="grid grid-cols-12 mt-2">
                    <div class="col-span-3">Pengiriman</div>
            ...
            <div class="flex mt-4">
                <button class="py-2 px-4 bg-[#ff950b] hover:bg-[#ff9f21] font-semibold">konfirmasi</button>
                <button class="py-2 px-4 bg-white hover:bg-gray-200 ml-4 font-semibold">batalkan</button>
            </div>
        </section>
    </main>
<?= $this->endSection()?>