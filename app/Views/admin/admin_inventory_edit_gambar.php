...
<?= $this->section('content')?>
    <main class="w-10/12 md:w-4/5 ml-auto px-2 py-10 md:px-12 md:py-4">
        <section class="w-full h-auto py-8 px-12 rounded-lg bg-slate-400">
            ...
            <div class="bg-slate-100 rounded-b-lg mt-1 py-4 px-8 font-semibold">
                <div class="flex mb-4">
                    <div class="flex">
                        <div class="w-48">
                    ...
                    <div class="flex ml-auto">
                        <div class="w-48">
                            ...
                            <img class="relative object-cover rounded-lg border-2 border-sky-500 h-48" src="/img/air_jordan_7_3.jpg" alt="">
                        </div>
                        <div class="col-span-3 ml-8 mr-4 self-center">
                            <button class="py-2 px-4 mb-5 w-24 block bg-[#ff950b] hover:bg-[#f28900] text-white font-semibold rounded-sm">delete</button>
                            <button class="py-2 px-4 w-24 block border-2 border-[#f28900] hover:bg-[#f28900] hover:border-[#f28900] hover:text-white font-semibold rounded-sm">change</button>
                ...
                <div class="flex mb-4">
                    <div class="flex">
                        <div class="w-48">
                            ...
                            <img class="relative object-cover rounded-lg border-2 border-sky-500 h-48" src="/img/air_jordan_7_2.jpg" alt="">
                        </div>
                        <div class="col-span-3 ml-8 mr-4 self-center">
                            <button class="py-2 px-4 mb-5 w-24 block bg-[#ff950b] hover:bg-[#f28900] text-white font-semibold rounded-sm">delete</button>
                            <button class="py-2 px-4 w-24 block border-2 border-[#f28900] hover:bg-[#f28900] hover:border-[#f28900] hover:text-white font-semibold rounded-sm">change</button>
                    ...
                    <div class="flex ml-auto">
                        <div class="w-48">
                            ...
                            <img class="relative object-cover rounded-lg border-2 border-sky-500 h-48" src="/img/air_jordan_7.jpg" alt="">
                        </div>
                        <div class="col-span-3 ml-8 mr-4 self-center">
                            <button class="py-2 px-4 mb-5 w-24 block bg-[#ff950b] hover:bg-[#f28900] text-white font-semibold rounded-sm">delete</button>
                            <button class="py-2 px-4 w-24 block border-2 border-[#f28900] hover:bg-[#f28900] hover:border-[#f28900] hover:text-white font-semibold rounded-sm">change</button>
