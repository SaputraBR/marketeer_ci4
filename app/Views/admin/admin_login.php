...
<body class="max-w-screen-2xl max-h-max mx-auto">
    <div class="box-main">
        ...
        <?php } ?>
        <div class="content">
            <div class="relative h-3/4 w-2/3 mx-auto top-1/2 bg-slate-600/[.7] rounded-lg" style="transform: translateY(-50%)">
                <form method="post" action="/logging" enctype="multipart/form-data" class="w-3/4 mx-auto pt-4">
                    ...
                    <label for="kode" class="font-bold text-lg text-white">Password</label>
                    <input type="password" name="kode" class="block w-full rounded-lg bg-slate-100 py-1 px-2 mx-auto border focus:border-sky-300 focus:ring-sky-300 focus:ring-1 focus:outline-none">

                    <div class="flex justify-center mt-6">
                        <button type="submit" class="px-4 py-2 rounded-lg font-bold bg-slate-200">Login</button>
                    </div>
                </form>
