    ...
    <main class="w-10/12 md:w-4/5 ml-auto px-2 py-10 md:px-12 md:py-4">
        <section class="w-full h-auto py-8 px-12 rounded-lg bg-slate-400">
            ...
            <div class="mt-1 bg-slate-100 py-6 px-8 font-semibold">
                <div class="flex mb-2">
                    <div>
                        <h1 class="text-xl">Laporan Margin Per Barang</h1>
                ...
                <div class="border-x-2 border-b-2 border-slate-400">
                    <div class="grid grid-cols-12 border-y-2 border-slate-400">
                        ...
                        <div class="col-span-3 flex justify-center border-r-2 border-slate-400">Nama</div>
                        <div class="col-span-1 flex justify-center border-r-2 border-slate-400">Qty</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400">HPP</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400">Total</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400">Laba</div>
                        <div class="col-span-1 flex justify-center">Margin</div>
                    </div>

                    <div class="grid grid-cols-12" id="item-line">
                        <div class="col-span-1 flex justify-center border-r-2 border-slate-400" id="no">1</div>
                        <div class="col-span-3 flex justify-center border-r-2 border-slate-400 p-1" id="item-name">Air Jordan 7 Retro SE Men's Shoes</div>
                        <div class="col-span-1 flex justify-center border-r-2 border-slate-400" id="qty">2</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400" id="hpp">3,000,123</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400" id="total">6,800,000</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400" id="laba"></div>
                        <div class="col-span-1 flex justify-center" id="margin"></div>
                    </div>
                    <div class="grid grid-cols-12" id="item-line">
                        <div class="col-span-1 flex justify-center border-r-2 border-slate-400" id="no">2</div>
                        <div class="col-span-3 flex justify-center border-r-2 border-slate-400 p-1" id="item-name">Polo Bear by Ralph Lauren M/L/XL/XXL</div>
                        <div class="col-span-1 flex justify-center border-r-2 border-slate-400" id="qty">1</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400" id="hpp">10,845,631</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400" id="total">13,020,000</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400" id="laba"></div>
                        <div class="col-span-1 flex justify-center" id="margin"></div>
                    </div>
                </div>
