        ...
        <section class="w-full h-auto py-8 px-12 rounded-lg bg-slate-400">
            <div class="bg-slate-100 py-6 px-8 rounded-t-lg font-semibold">
                <form class="mb-0">
                    ...
                    <input type="text" name="nama" id="nama" class="rounded-md mb-2 px-2 py-1 border border-slate-300 focus:border-sky-500 focus:ring-sky-500 focus:ring-1 focus:outline-none">
                    <label for="period" class="block mb-2">Pilih Periode :</label>
                    <input type="date" id="period-start" name="period-start" class="rounded-md px-2 py-1 border border-slate-300 focus:border-sky-500 focus:ring-sky-500 focus:ring-1 focus:outline-none">
                    <input type="date" id="period-end" name="period-end" class="rounded-md px-2 py-1 border border-slate-300 focus:border-sky-500 focus:ring-sky-500 focus:ring-1 focus:outline-none">
            ...
            <div class="mt-1 bg-slate-100 py-6 px-8 font-semibold">
                ...
                <div class="border-x-2 border-b-2 border-slate-400">
                    <div class="grid grid-cols-12 border-y-2 border-slate-400">
                        ...
                        <div class="col-span-3 flex justify-center border-r-2 border-slate-400">No Nota</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400">Harga</div>
                        ...
                        <div class="col-span-3 flex justify-center">Tanggal</div>                        
                    </div>
                    <div class="grid grid-cols-12 text-sm" id="item-line">
                        ...
                        <div class="col-span-3 flex justify-center border-r-2 border-slate-400">FM231001001</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400">3,000,123</div>
                        ...
                        <div class="col-span-3 flex justify-center">01/10/23</div>
                    </div>
                    <div class="grid grid-cols-12 text-sm" id="item-line">
                        <div class="col-span-1 flex justify-center border-r-2 border-slate-400">2</div>
                        <div class="col-span-3 flex justify-center border-r-2 border-slate-400">RM231001001</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400">3,000,123</div>
                        <div class="col-span-1 flex justify-center border-r-2 border-slate-400">1</div>
                        <div class="col-span-2 flex justify-center border-r-2 border-slate-400">-3,000,123</div>
                        <div class="col-span-3 flex justify-center">02/10/23</div>
                    </div>
                </div>
            </div>
