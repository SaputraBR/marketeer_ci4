            ...
            <div class="">
                <div class="grid grid-cols-12 border-b-2">
                    ...
                    <p class="col-span-2 p-4 flex justify-center">
                        <a href="/adm/order/diterima/detail">FK23010606</a>
                    </p>
                    <p class="col-span-6 p-4 flex justify-center">
                        <a href="/adm/order/diterima/detail">Isla Trinidad 1548, V9410FFH Ushuaia, Tierra del Fuego, Argentin</a>
                    </p>
                    <p class="col-span-3 p-4 flex justify-center">
                        <a href="/adm/order/diterima/detail" class="py-1 px-2 rounded-lg bg-blue-600 text-white font-semibold">diterima</a>
                    </p>
                </div>
            </div>
        </section>
