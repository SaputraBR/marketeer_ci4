    ...
    <main class="flex w-auto sm:grid grid-cols-3 mt-4 sm:mt-10">
        <div class="col-span-1 w-auto mx-1">
            <div class="w-full sticky top-28 sm:top-32">
                ...
                <div class="flex mt-4 sm:w-2/3 bg-white sm:mx-auto rounded-sm border-2 border-slate-300 hover:bg-slate-100 hover:cursor-pointer flex py-2 sm:py-0 px-2 sm:px-0">
