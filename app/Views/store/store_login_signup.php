    ...
    <div class="box-main">
        <div class="content">
            <div class="w-full h-full bg-white pt-4 container-log">
                ...
                <form action="" class="w-4/5 mx-auto">
                    <label for="user" class="font-semibold">Nama    </label>
                    <input type="text" name="user" class="block w-full rounded-sm bg-slate-100 mb-2 py-1 px-2 mx-auto border focus:border-sky-300 focus:ring-sky-300 focus:ring-1 focus:outline-none">
                    
                    <label for="password" class="font-semibold">Password</label>
                    <div class="flex relative mb-2">
                        <input type="password" name="password" class="w-full rounded-sm bg-slate-100 py-1 px-2 mx-auto border focus:border-sky-300 focus:ring-sky-300 focus:ring-1 focus:outline-none">
                    ...
                    <label for="password" class="font-semibold">Konfirmasi Password</label>
